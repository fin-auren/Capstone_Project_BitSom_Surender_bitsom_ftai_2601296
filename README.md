...
Executive Certification in FinTech & Artificial Intelligence -- capstone submission.

One connected platform across three internally-linked parts, all in this single repository:

| Part | Folder | Paytm vertical | Marks |
|---|---|---|---|
| 1 | [`payments_fraud_analytics/`](payments_fraud_analytics/) | Payments (UPI / Wallet / QR) | 35 |
| 2 | [`credit_risk_lending_ml/`](credit_risk_lending_ml/) | Postpaid / Lending (BNPL) | 40 |
| 3 | [`ai_advisory_blockchain/`](ai_advisory_blockchain/) | Money / Wealth advisory + blockchain appendix | 25 |

All monetary figures throughout the project are in **INR**. All synthetic datasets are
generated by committed, seeded (`seed=42` / `np.random.seed(42)`) scripts -- no real Paytm data
is used anywhere.
