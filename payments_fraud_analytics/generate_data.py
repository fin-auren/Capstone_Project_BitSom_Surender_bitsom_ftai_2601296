"""
Seed-data generator for Part 1 -- Payments & Fraud Analytics.

IMPORTANT: parameters, seed (42), and injected-fraud counts must not change --
grading / the SQL + reconciliation acceptance criteria depend on this exact logic.
Must be run with this folder as the working directory:
